...
### 6. Architecture Decision Records (ADR) & Trade-off Analysis
**Critical**: For any significant architectural choice, you **MUST** document the decision.

-   **Structure**:
    -   **Context**: What problem are we solving?
    -   **Options**: Option A vs Option B.
    -   **Trade-offs**: Pros/Cons of each (Performance, Cost, Complexity).
    -   **Decision**: What we chose and why.
    -   **Consequences**: What becomes harder/easier?

-   **Example**: "Redis vs In-Memory Cache for Rate Limiting"
